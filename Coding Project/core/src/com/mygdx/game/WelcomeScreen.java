...
public class WelcomeScreen implements Screen {
    ...
    public void show() {
        ...
        usernameField.setPosition(Gdx.graphics.getWidth() / 2 - usernameField.getWidth() / 2, Gdx.graphics.getHeight() / 2 + usernameField.getHeight());

        passwordField = new TextField("", textFieldStyle);
        passwordField.setMessageText("Password");
        passwordField.setPasswordMode(true);
        passwordField.setPasswordCharacter('*');
        passwordField.setPosition(Gdx.graphics.getWidth() / 2 - passwordField.getWidth() / 2, Gdx.graphics.getHeight() / 2);
    ...
    // Other methods (pause, resume, hide, dispose) can remain as is
}
